<template>
  ...
  <div class="col-md-12 mb-4 input-group">
    ...
    <div class="input-group-append" v-if="selected.length">
  ...
  <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
    <div class="col" v-for="product in products" :key="product.id" @click="select(product.id)">
      <div class="card" :class="selected.some(s => s === product.id) ? 'selected' : 'shadow-sm'">
        <img :src="product.image" :alt="product.title" width="419" height="314">
